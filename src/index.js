        ...
        exit(path) {
          ...
          for (let path of body) {
            ...
            if (path.isImportDeclaration()) {
              ...
              if (declaration.isFunctionDeclaration()) {
                ...
                let defNode = t.stringLiteral("default");
                if (id) {
                ...
                path.replaceWith(buildExportsAssignment(t.stringLiteral("default"), declaration.node));
              ...
              if (declaration.node) {
                if (declaration.isFunctionDeclaration()) {
                  ...
                  path.replaceWithMultiple([
                    declaration.node,
                    buildExportsAssignment(t.stringLiteral(id.name), id)
                  ]);
          ...
          if (hasImports && Object.keys(nonHoistedExportNames).length) {
            ...
            for (let name in nonHoistedExportNames) {
              hoistedExportsNode = buildExportsAssignment(t.stringLiteral(name), hoistedExportsNode).expression;
            }
